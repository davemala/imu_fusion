...
class IMUDifferencePlotter(Node):
    ...
    def imu1_callback(self, msg):
        self.imu1_data = msg.linear_acceleration.x  # Usa un asse specifico
        self.compute_difference()

    def imu2_callback(self, msg):
        self.imu2_data = msg.linear_acceleration.x  # Usa lo stesso asse
        #self.compute_difference()
    ...
    def plot_loop(self):
        ...
        line_med, = ax.plot(2, 2, 'y-', label="Media")
